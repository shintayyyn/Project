...
if ($child['is_regular'] == 1) {
    ...
    $dominant_section = $sec_row['dominant_irregular_section'] ?? 'N/A';
    $degree_code = $sec_row['irregular_degree'] ?? 'N/A';
    $year_level = $sec_row['year_level'] ?? 'N/A';
                        ...
                        <div class="dropdown" style="max-width:400px">
                            ...
                            while ($c = $children->fetch_assoc()) {
                                if ($c['s_id'] == $selected_child_id) {
                                    $selected_child_name = htmlspecialchars($c['full_name']) . " (" . ($child['section_code'] ?? 'N/A') . ")";
                                    break;
                                }
                            }
                            ?>
                            ...
                            <ul class="dropdown-menu custom-scrollbar" aria-labelledby="childDropdown">
                                ...
                                $children->data_seek(0);
                                while ($c = $children->fetch_assoc()):
                                    $child_label = htmlspecialchars($c['full_name']) . " (" . ($child['section_code'] ?? 'N/A') . ")";
                                ?>
                        ...
                        <div class="card-header py-3" style="background: var(--tertiary)">
                            <div class="row">
                                ...
                                <div class="col text-end">
                                     <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#studyLoadModal<?= $child['s_id']; ?>">
