...
try {
    ...
    $stmt->bind_param("isssssss", $section_id, $day_of_week, $start_time, $end_time, 
    ...
    $stmt->bind_param("isssssss", $teacher_id, $day_of_week, $start_time, $end_time, 
                      $start_time, $end_time, $start_time, $end_time);
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    $stmt->bind_param("ssssssss", $room, $day_of_week, $start_time, $end_time, 
                      $start_time, $end_time, $start_time, $end_time);
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    $stmt->bind_param("ississss", $section_id, $subject_code, $subject_description, 
